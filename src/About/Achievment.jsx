...
const Achievment = () => {
 ...
 <h1 className="text-5xl text-center font-semibold">Our Achievment</h1>
            ...
            <div className="card bg-slate-100 w-80  mb-5 lg:mb-0 mx-auto h-44"data-aos="fade-right"data-aos-duration="1000">
...
<div className="card mb-5 lg:mb-0 mx-auto  bg-slate-100 w-80 "data-aos="fade-right"data-aos-duration="1000">
  <div className="card-body font-semibold text-4xl pt-12 ">
...
<div className="card mb-5 lg:mb-0 mx-auto  bg-slate-100 w-80" data-aos="fade-left" data-aos-duration="1000">
  <div className="card-body font-semibold text-4xl pt-12">
...
<div className="card  mx-auto bg-slate-100 w-80"data-aos="fade-left" data-aos-duration="1000">
  <div className="card-body font-semibold text-4xl pt-12" >
