...
const handlePrivate = () => {
 ...
 <div className="max-w-xl mb-36 lg:mb-20">
...
<div className='flex bg-[#F3F3F3] bg-opacity-75  text-indigo-600 lg:text-lg lg:text-semibold mt-10 lg:mt-36 py-2 lg:p-2 rounded-full '>
 ...
 {user?
      ...
      :(
        <button onClick={handlePrivate} className="btn btn-xs lg:btn-sm rounded-full text-white lg:text-lg border-none m-1 lg:ml-5 bg-blue-600 hover:bg-blue-600">Book Now<FaArrowRight className='w-3.5 h-3.5 '/></button>
      )}
</div>
  </div>
